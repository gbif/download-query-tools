  ...
  private HiveSqlOperatorTable() {
    ...
    final SqlFunction LOG2 =
        SqlBasicFunction.create(
            "LOG2", ReturnTypes.DOUBLE_NULLABLE, OperandTypes.NUMERIC, SqlFunctionCategory.NUMERIC);
    ...
    final SqlFunction E =
        SqlBasicFunction.create(
                "E", ReturnTypes.DOUBLE, OperandTypes.NILADIC, SqlFunctionCategory.NUMERIC)
    ...
    // Date functions
    final SqlFunction FROM_UNIXTIME =
        SqlBasicFunction.create(
            "FROM_UNIXTIME",
            ReturnTypes.VARCHAR_2000,
            OperandTypes.or(
                family(SqlTypeFamily.NUMERIC), family(SqlTypeFamily.NUMERIC, SqlTypeFamily.STRING)),
            SqlFunctionCategory.TIMEDATE);
    additionalOperators.add(FROM_UNIXTIME);

    final SqlFunction UNIX_TIMESTAMP =
        SqlBasicFunction.create(
            "UNIX_TIMESTAMP",
            ReturnTypes.INTEGER,
            OperandTypes.or(
    ...
    final SqlBasicFunction DATE_ADD =
        SqlBasicFunction.create(
            "DATE_ADD",
            ReturnTypes.VARCHAR_NULLABLE,
    ...
    final SqlBasicFunction FROM_UTC_TIMESTAMP =
        SqlBasicFunction.create(
            "FROM_UTC_TIMESTAMP",
    ...
    final SqlFunction MONTHS_BETWEEN =
        SqlBasicFunction.create(
            "MONTHS_BETWEEN",
            ReturnTypes.DOUBLE,
            OperandTypes.family(SqlTypeFamily.DATE, SqlTypeFamily.DATE),
    ...
    final SqlFunction ASSERT_TRUE =
        SqlBasicFunction.create("ASSERT_TRUE", ReturnTypes.BOOLEAN, OperandTypes.BOOLEAN);
    ...
    final SqlFunction ELT =
        SqlBasicFunction.create(
            "ELT", ReturnTypes.VARCHAR_NULLABLE, OperandTypes.VARIADIC, SqlFunctionCategory.STRING);
    ...
    final SqlFunction IN_FILE =
        SqlBasicFunction.create(
            "IN_FILE", ReturnTypes.BOOLEAN, OperandTypes.STRING_STRING, SqlFunctionCategory.STRING);
    ...
    final SqlFunction PRINTF =
        SqlBasicFunction.create(
            "PRINTF", ReturnTypes.VARCHAR, OperandTypes.VARIADIC, SqlFunctionCategory.STRING);
    additionalOperators.add(PRINTF);

    final SqlFunction QUOTE =
        SqlBasicFunction.create(
            "QUOTE", ReturnTypes.VARCHAR_NULLABLE, OperandTypes.STRING, SqlFunctionCategory.STRING);
    ...
    final SqlBasicFunction MASK_FIRST_N =
        SqlBasicFunction.create(
            "MASK_FIRST_N",
            ReturnTypes.VARCHAR_NULLABLE,
            family(
